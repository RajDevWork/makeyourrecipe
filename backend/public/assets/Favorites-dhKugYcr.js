import{r as n,I as m,n as e,p as l,H as x}from"./index-CIU3cpb5.js";import{R as g}from"./RecipeCard-Bvncq3aq.js";import{S as d}from"./SkeletonCard-FwewM8Dj.js";import{B as h}from"./bookmark-BQTk9Rrf.js";import"./recipeService-CDqM8tdv.js";import"./eye-B8VXfbnA.js";const N=()=>{const[a,c]=n.useState([]),[t,i]=n.useState(!0);n.useEffect(()=>{o()},[]);const o=async()=>{i(!0);try{const r=await m.getFavorites();c(r.data||[])}catch(r){console.error("Error fetching favorites:",r)}finally{i(!1)}};return t&&a.length===0?e.jsx("div",{className:"min-h-screen bg-slate-50 dark:bg-slate-950",children:e.jsxs("div",{className:"container mx-auto px-4 py-8",children:[e.jsx("div",{className:`\r
            h-[220px]\r
            rounded-[40px]\r
            mb-10\r
            animate-pulse\r
