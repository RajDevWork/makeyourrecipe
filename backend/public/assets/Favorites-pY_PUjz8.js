import{r as n,I as m,n as e,p as l,H as x}from"./index-BO43ITrN.js";import{R as g}from"./RecipeCard-bybBsQRc.js";import{S as d}from"./SkeletonCard-DW_nf5OL.js";import{B as h}from"./bookmark-CDyrMyZL.js";import"./recipeService-rlqG3h8S.js";import"./eye-CxdXcIvh.js";const N=()=>{const[a,c]=n.useState([]),[t,i]=n.useState(!0);n.useEffect(()=>{o()},[]);const o=async()=>{i(!0);try{const r=await m.getFavorites();c(r.data||[])}catch(r){console.error("Error fetching favorites:",r)}finally{i(!1)}};return t&&a.length===0?e.jsx("div",{className:"min-h-screen bg-slate-50 dark:bg-slate-950",children:e.jsxs("div",{className:"container mx-auto px-4 py-8",children:[e.jsx("div",{className:`\r
            h-[220px]\r
            rounded-[40px]\r
            mb-10\r
            animate-pulse\r
