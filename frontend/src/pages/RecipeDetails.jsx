  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 -mt-24">
        <div className="rounded-[32px] bg-white dark:bg-slate-900
border border-slate-800
shadow-2xl shadow-black/20 p-8">
          <div className="h-10 w-72 bg-slate-200 dark:bg-slate-800 rounded animate-pulse mb-8" />

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="h-[400px] rounded-3xl bg-slate-200 dark:bg-slate-800 animate-pulse" />
            <div className="h-[400px] rounded-3xl bg-slate-200 dark:bg-slate-800 animate-pulse" />
          </div>
        </div>
      </div>
...
py-2">
    ...
    shadow-sm">
          ...
          <div className="flex flex-wrap gap-3 mb-6 pb-6 border-b border-slate-200 dark:border-slate-800">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                isLiked 
                  ...
                  : 'bg-slate-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-900/20'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                isBookmarked 
                  ...
                  : 'bg-slate-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-orange-900/20'
              }`}
            >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all"
              >
            ...
            {user?._id === recipe.author?._id && (
              <Link
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-orange-500 to-amber-500 text-white hover:bg-orange-600 transition-all"
              >
                Edit Recipe
              </Link>
            )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div className='rounded-[28px] bg-slate-50 dark:bg-slate-800/40 p-6'>
              ...
              <div className="flex flex-wrap gap-2">
                {recipe.tags.map((tag, idx) => (
                  <Link
                    key={idx}
                    to={`/explore?tags=${tag}`}
                    className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-gray-600 dark:text-gray-400 text-sm hover:bg-orange-100 dark:hover:bg-orange-900/20 transition-colors"
                  >
                    #{tag}
                  </Link>
                ))}
          ...
          <div className="mt-12">
            <div className="mb-8">
              ...
              <p className="mt-2 text-slate-500 dark:text-slate-400">
                Similar recipes curated for you
              </p>
            </div>
